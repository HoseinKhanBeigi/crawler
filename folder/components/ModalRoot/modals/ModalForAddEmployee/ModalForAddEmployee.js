...
const mapState = state => ({
  selectedRole:
    state.employeeManagement?.lastEmployeeAddedInfo?.selectedRole ||
    state.employeeManagement?.lastEmployeeAddedInfo?.role?.code,
  employeeInfoDetail:
    state.employeeManagement?.lastEmployeeAddedInfo?.userInfoDetail ||
    state.employeeManagement?.lastEmployeeAddedInfo ||
    {},
});
