...
import { DRAWER_FOR_EDIT_CALL_DETAILS_WITH_CALLER_LEVANTID } from '../../repository';
import {
  getTemplatesAction,
...
const DrawerForEditCallDetailWithCallerLevantId = props => {
  ...
  return (
    <KianDrawer
      ...
      onCancel={closeModal}
      onClose={closeModal}
      drawerId={DRAWER_FOR_EDIT_CALL_DETAILS_WITH_CALLER_LEVANTID}
    >
      <FormBuilder
        schema={schema(
          phoneCallTypes,
...
DrawerForEditCallDetailWithCallerLevantId.defaultProps = {
  templates: [],
  data: {},
  levantId: null,
};
DrawerForEditCallDetailWithCallerLevantId.propTypes = {
...
export default connect(
  mapStateToProps,
  mapDispatch,
)(DrawerForEditCallDetailWithCallerLevantId);
