    ...
    if (scoreNumber) {
      am4core.ready(() => {
        ...
        hand.events.on('positionchanged', () => {
          ...
          const matchingGrade2 = lookUpGrade(
            axis.positionToValue(hand.currentPosition),
            data.gradingData,
          );
          label2.text = matchingGrade2.title.toUpperCase();
          label2.fill = am4core.color(matchingGrade2.color);
          label2.stroke = am4core.color(matchingGrade2.color);
          label.fill = am4core.color(matchingGrade2.color);
        });
      });
    }
  }, [scoreNumber]);
