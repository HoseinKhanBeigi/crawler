...
import StackHoldersForm from '../../components/StackHoldersForm';
...
import StackHolderStatusKYC from '../StackHolderStatusKYC';

const StackHoldersTabContent = props => {
...
StackHoldersTabContent.propTypes = {
...
export default connect(
  mapState,
  mapDispatch,
)(memo(withStyles(s)(StackHoldersTabContent)));
