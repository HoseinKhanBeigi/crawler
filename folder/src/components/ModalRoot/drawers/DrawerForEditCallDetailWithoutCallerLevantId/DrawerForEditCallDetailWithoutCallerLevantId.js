...
import { DRAWER_FOR_EDIT_CALL_DETAILS_WITHOUT_CALLER_LEVANTID } from '../../repository';
import {
  getTemplatesAction,
...
import s from './DrawerForEditCallDetailWithoutCallerLevantId.scss';
import KianDrawer from '../../../KianDrawer/KianDrawer';

const { Item } = Descriptions;
const DrawerForEditCallDetailWithoutCallerLevantId = props => {
  ...
  return (
    <KianDrawer
      ...
      onCancel={closeModal}
      onClose={closeModal}
      drawerId={DRAWER_FOR_EDIT_CALL_DETAILS_WITHOUT_CALLER_LEVANTID}
    >
      {visibleSearchFilter && (
        <Row gutter={24}>
...
DrawerForEditCallDetailWithoutCallerLevantId.defaultProps = {
  templates: [],
  data: {},
  levantId: null,
};
DrawerForEditCallDetailWithoutCallerLevantId.propTypes = {
...
export default connect(
  mapStateToProps,
  mapDispatch,
)(withStyles(s)(DrawerForEditCallDetailWithoutCallerLevantId));
