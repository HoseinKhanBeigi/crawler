...
const StackHolderStatusKYC = props => {
  ...
  const handleCheckStatusForNotApprove = status => {
    switch (status) {
      ...
      default:
        return renderStatusNotKYC(
          'این کاربر به مرحله بررسی اطلاعات نرسیده است',
        );
    }
  };
