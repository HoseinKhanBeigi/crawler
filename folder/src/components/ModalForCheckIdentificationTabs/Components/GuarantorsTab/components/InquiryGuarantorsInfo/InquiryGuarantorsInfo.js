...
import s from './InquiryGuarantorsInfo.scss';
...
const InquiryGuarantorsInfo = ({ nationalCode }) => {
...
InquiryGuarantorsInfo.propTypes = {
...
export default connect(mapState)(withStyles(s)(InquiryGuarantorsInfo));
